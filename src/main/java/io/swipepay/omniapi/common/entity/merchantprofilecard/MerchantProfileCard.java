...
import io.swipepay.omniapi.common.entity.card.Card;
import io.swipepay.omniapi.common.entity.merchantprofile.MerchantProfile;

@Entity
@Table(uniqueConstraints = {
		@UniqueConstraint(columnNames = {"merchant_profile_id", "card_id"})
})
public class MerchantProfileCard {
	@Id
	@GeneratedValue
	private Long id;
