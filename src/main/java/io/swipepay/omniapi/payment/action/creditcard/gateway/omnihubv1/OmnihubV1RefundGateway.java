...
@Service
public class OmnihubV1RefundGateway extends OmnihubV1Gateway {
...
//			OmnihubV1Response omnihubV1Response = restTemplate.postForObject("/v1.0/refunds", httpEntity, OmnihubV1Response.class);
...
//		omnihubV1Request.setTransactionId(purchasePaymentCc.getTxId());
//		omnihubV1Request.setReference(paymentCc.getReference());
